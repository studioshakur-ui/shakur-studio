...
export const translations: Record<Language, Dictionary> = {
  fr: {
    ...
    'hero.buildSystem': 'Construire mon système',
    'hero.builtBy': 'Construit par SHAKUR',

    'agents.kicker': 'Console',
    'agents.title': 'Tester l’intelligence du studio.',
    'agents.copy': 'Décris une idée, un site ou un workflow. Reçois une direction.',
    ...
    'caps.eyebrow': 'Capacités',
    'caps.title': 'Ce que Shakur Studio construit.',
    'caps.web.title': 'Web Systems',
    'caps.web.copy': 'Des interfaces qui transforment l’attention en action qualifiée.',
    'caps.ai.title': 'AI Interfaces',
    'caps.ai.copy': 'Des agents conçus autour d’une vraie logique business, pas un chat générique.',
    'caps.auto.title': 'Automation',
    'caps.auto.copy': 'Des workflows qui suppriment la friction manuelle et créent du flux opérationnel.',

    'contact.kicker': 'Construisons ton système',
    'contact.title': 'Besoin de plus qu’un site web ? Construisons le système.',
  ...
  it: {
    ...
    'hero.buildSystem': 'Costruisci il mio sistema',
    'hero.builtBy': 'Costruito da SHAKUR',

    'agents.kicker': 'Console',
    'agents.title': 'Provare l’intelligenza dello studio.',
    'agents.copy': 'Descrivi un’idea, un sito o un workflow. Ricevi una direzione.',
    ...
    'caps.eyebrow': 'Capacità',
    'caps.title': 'Cosa costruisce Shakur Studio.',
    'caps.web.title': 'Web Systems',
    'caps.web.copy': 'Interfacce che trasformano l’attenzione in azione qualificata.',
    'caps.ai.title': 'AI Interfaces',
    'caps.ai.copy': 'Agenti progettati intorno a una vera logica business, non una chat generica.',
    'caps.auto.title': 'Automation',
    'caps.auto.copy': 'Workflow che eliminano la frizione manuale e creano flusso operativo.',

    'contact.kicker': 'Costruiamo il tuo sistema',
    'contact.title': 'Ti serve più di un sito? Costruiamo il sistema.',
  ...
  en: {
    ...
    'hero.buildSystem': 'Build my system',
    'hero.builtBy': 'Built by SHAKUR',

    'agents.kicker': 'Console',
    'agents.title': 'Test the studio intelligence.',
    'agents.copy': 'Describe an idea, a website or a workflow. Get a direction.',
    ...
    'caps.title': 'What Shakur Studio builds.',
    'caps.web.title': 'Web Systems',
    'caps.web.copy': 'Interfaces that turn attention into qualified action.',
    'caps.ai.title': 'AI Interfaces',
    'caps.ai.copy': 'Agents designed around real business logic, not generic chat.',
    'caps.auto.title': 'Automation',
    'caps.auto.copy': 'Workflows that remove manual friction and create operational flow.',

    'contact.kicker': 'Let’s build your system',
    'contact.title': 'Need more than a website? Let’s build the system.',
