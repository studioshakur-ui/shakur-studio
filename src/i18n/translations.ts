...
export const translations: Record<Language, Dictionary> = {
  fr: {
    ...
    'a11y.brand': 'CNCS Systems — accueil',
    'a11y.nav': 'Navigation principale',
    'a11y.language': 'Sélecteur de langue',
    'hero.kicker': 'Cognitive Networked Control Systems',
    'hero.titleA': 'Pas seulement des sites.',
    'hero.titleB': 'Des systèmes qui pensent,',
    'hero.titleC': 'guident et automatisent.',
    'hero.copy': 'CNCS transforme une offre, un workflow ou une idée en système digital intelligent — pensé pour la clarté, la conversion et l’exécution.',
    ...
    'agents.title': 'Trois agents CNCS, en façade.',
    ...
    'agents.turnIntoSystem': 'En faire un système CNCS',
    ...
    'systems.kicker': 'Ce que CNCS construit',
    ...
    'process.kicker': 'Méthode CNCS',
    'process.title': 'Chaque système CNCS suit une seule chaîne.',
    ...
    'final.copy': 'Décris ton contexte. CNCS revient sous 24 h avec un plan de système ciblé, pas un devis générique.',
  ...
  it: {
    ...
    'hero.copy': 'CNCS trasforma un’offerta, un workflow o un’idea in un sistema digitale intelligente — pensato per chiarezza, conversione ed esecuzione.',
    ...
    'agents.title': 'Tre agenti CNCS, in vetrina.',
    ...
    'agents.turnIntoSystem': 'Trasformare in sistema CNCS',
    ...
    'systems.kicker': 'Cosa costruisce CNCS',
    ...
    'process.kicker': 'Metodo CNCS',
    'process.title': 'Ogni sistema CNCS segue una sola catena.',
    ...
    'final.copy': 'Descrivi il contesto. CNCS torna entro 24 h con un piano di sistema mirato, non un preventivo generico.',
  ...
  en: {
    ...
    'hero.copy': 'CNCS turns offers, workflows and ideas into intelligent digital systems — built for clarity, conversion and execution.',
    ...
    'agents.title': 'Three CNCS agents, on the front line.',
    ...
    'agents.turnIntoSystem': 'Turn this into a CNCS system',
    ...
    'systems.kicker': 'What CNCS builds',
    ...
    'process.kicker': 'CNCS method',
    'process.title': 'Every CNCS system follows one chain.',
    ...
    'final.copy': 'Describe your context. CNCS comes back within 24 h with a targeted system plan, not a generic quote.',
